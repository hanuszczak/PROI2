...
class PointSet2
{
 ...
 PointSet2(const PointSet2& Set1){
...
void  AddPoint(Point<T> &p) {
    ...
    sort(Members.begin(), Members.end(),Point<T>::Compare);
}
PointSet2  operator+(PointSet2 &A) {
    PointSet2 B;
    B.Members = Members;
    B += A;
    return B;
}
void  operator+=(PointSet2 &A){
